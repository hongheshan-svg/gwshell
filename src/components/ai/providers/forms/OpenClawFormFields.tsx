...
import type { ProviderCategory, OpenClawModel } from "../../lib/types";
            ...
            {models.map((model, index) => (
              ...
              >
                <div className="flex items-center">
                  ...
                  >
                    {index === 0
                      ? t("openclaw.primaryModel", { defaultValue: "默认模型" })
                      : t("openclaw.fallbackModel", { defaultValue: "回退模型" })}
                  </span>
                </div>
                ...
                >
                  ...
                  <CollapsibleContent className="space-y-3 pt-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 space-y-1">
                        <label className="text-xs text-muted-foreground">
                          {t("openclaw.inputTypes", { defaultValue: "输入类型" })}
                        </label>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 space-y-1">
                        <label className="text-xs text-muted-foreground">
                          {t("openclaw.inputCost", { defaultValue: "输入价格 ($/M tokens)" })}
                        </label>
                        <Input
                          type="number"
                          step="0.001"
                      ...
                      <div className="flex-1 space-y-1">
                        <label className="text-xs text-muted-foreground">
                          {t("openclaw.outputCost", { defaultValue: "输出价格 ($/M tokens)" })}
                        </label>
                        <Input
                          type="number"
                          step="0.001"
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 space-y-1">
                        <label className="text-xs text-muted-foreground">
                          {t("openclaw.cacheReadCost", { defaultValue: "缓存读取价格 ($/M tokens)" })}
                        </label>
                        <Input
                          type="number"
                          step="0.001"
                      ...
                      <div className="flex-1 space-y-1">
                        <label className="text-xs text-muted-foreground">
                          {t("openclaw.cacheWriteCost", { defaultValue: "缓存写入价格 ($/M tokens)" })}
                        </label>
                        <Input
                          type="number"
                          step="0.001"
                          ...
                          onChange={(e) =>
                            handleCostChange(index, "cacheWrite", e.target.value)
                          }
                          placeholder="3.75"
                        />
                      </div>
