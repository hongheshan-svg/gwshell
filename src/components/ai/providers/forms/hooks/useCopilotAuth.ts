/**
 * useCopilotAuth - GWShell stub
 *
 * GitHub Copilot authentication requires the VSCode extension environment.
 * This stub provides the same interface so ProviderForm.tsx compiles,
 * but returns "not authenticated" state.
 */
import type { GitHubAccount } from "./useManagedAuth";
