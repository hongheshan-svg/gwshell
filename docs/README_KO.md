...
RDP 접속, Telnet, VNC 뷰어, 파일 동기화, 명령어 스니펫, 세션 녹화, 다국어 i18n, 탭 드래그 앤 드롭, SSH config 가져오기, CC-Switch 심층 통합, 플러그인 시스템
...
- [HexHub](https://github.com/user/hexhub) — SFTP 브라우저 및 화면 분할 디자인에 영감
- [CC-Switch](https://github.com/farion1231/cc-switch) — AI 프로바이더 관리에 영감
